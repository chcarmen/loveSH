...
function drawScoreboard() {
	...
	if (gameState === 0) {
		renderText(trueCanvas.width / 2 + gdx + 6 * settings.scale, trueCanvas.height / 2.1 + gdy - 155 * settings.scale, 150, "#ffffff", "LoveSH 消消乐");
		renderText(trueCanvas.width / 2 + gdx + 5 * settings.scale, h + 10, fontSize, "#ffffff", '开始');
	} else if (gameState != 0 && textOpacity > 0) {
		textOpacity -= 0.05;
		renderText(trueCanvas.width / 2 + gdx + 6 * settings.scale, trueCanvas.height / 2 + gdy - 155 * settings.scale, 150, "#ffffff", "LoveSH 消消乐");
		renderText(trueCanvas.width / 2 + gdx + 5 * settings.scale, h, fontSize, "#ffffff", '开始');
